...
class TowerKeys(Toggle):
    ...
    Ex. Getting access to World 1 Tower Key will allow you to play 1-Tower, 1-4, 1-5, 1-6
    """
    display_name = "Tower Keys"

class Goal(Choice):
    """
    bowser: Obtain world 1-8 keys or bowser's castle key
    world9: Obtain 231 star coins and 9 world keys/bowser's castle key, beat all world 9 levels
    boss_tokens: Boss tokens are placed on each major boss, obtain x amount of tokens and beat bowser
    star_coins: Obtain x amount of star coins and beat bowser
    World 9 locations will be removed from the pool if goal isn't world 9
    """
    display_name = "Goal"
    option_bowser = 0
    option_world9 = 1
    option_boss_tokens = 2
    option_star_coins = 3
    default = 0
...
class StarCoinsAmount(Range):
    ...
    If goal is World 9, this will be set to 231
    """
